...
ENTRY main {
  ...
  EXPECT_TRUE(
      Cast<HloAsyncInstruction>(start)->AreOperandsAndOutputFullyBound());
}
...
ENTRY main {
  ...
  EXPECT_TRUE(
      Cast<HloAsyncInstruction>(update)->AreOperandsAndOutputFullyBound());
}
...
ENTRY main {
  ...
  EXPECT_TRUE(
      Cast<HloAsyncInstruction>(done)->AreOperandsAndOutputFullyBound());
}
